...
def cleaning(tweets):
	...
	additional_stopwords=['amp', '#paleo', '@', 'rt','paleo','#','whole30','paleodiet','paleolifestyle']
...
for i in range(fileCount):
	...
	#pprint (tweetsPaleo[0])
print len(tweetsPaleo)	
tweetsPaleo=cleaning(tweetsPaleo)
print len(tweetsPaleo)
unigrams=analysis(tweetsPaleo)
#print unigrams
